...
%         fig.Position = [0 0 960 640];
        ...
        A1 = subplot(4,1,2);
        plot(time(1:single_trial_length), P(i).rec(1, :),'LineWidth', 1, 'Color', 'k'); %#0072BD');
        ...
        A1.FontSize = 12;
        A1.LineWidth = 1;
        ylabel('Membrane potential (mV)','FontSize', 14, 'Rotation', 0);
% % %         
...
% 
        ...
        ylabel('Trials', 'FontSize', 14, 'Rotation', 0);
        A2.Box = 'off';
...
%           % A3 = subplot(2,1,2);
        ...
        ylabel('Firing rate (Hz)','FontSize', 14, 'Rotation', 0);
...
%         ylabel('Indenter feedback voltage');                     
        ...
        % plot(time(2:single_trial_length),vel_filtered, 'LineWidth',2,'Color', [0.9290 0.6940 0.1250], 'LineStyle',':');
