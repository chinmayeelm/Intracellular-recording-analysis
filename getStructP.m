function P = getStructP(dataDirectory,filename)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

date = datetime(replace(dataDirectory, '.','-'),'Format','dd-MM-uuuu');
cd (join(['D:\Work\Recordings\' dataDirectory '\'], ''))
...
flag_meas_table = readtable('D:\Work\Recordings\Antenna flagellum measurements\flagellum-length-measurements.xlsx');
