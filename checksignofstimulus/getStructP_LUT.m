function P = getStructP_LUT(dataDirectory,filename,LUTrow, clip_data_points, downsampleFactor)
...
if ~isnan(LUTrow.ON_dur)
    ON_dur = LUTrow.ON_dur;
    OFF_dur = LUTrow.OFF_dur;
    no_of_trials = LUTrow.no_of_trials;
    fs = LUTrow.fs;
    if isnan(no_of_trials)
